const data = {
  ...
  datasets: [
    {
      label: "Monthly Sales",
      backgroundColor: "rgba(90, 19, 188, 0.6)",
      borderColor: "rgba(175, 220, 19, 1)",
      borderWidth: 1,
      data: [65, 59, 80, 81, 56],
    },
  ],
...
document
  ...
  .addEventListener("mousemove", function (event) {
    const bars = myChart.getElementsAtEventForMode(
      event,
      "nearest",
      { intersect: true },
      true
...
document.getElementById("myChart").addEventListener("mouseleave", function () {
  myChart.data.datasets[0].backgroundColor = "rgba(175, 192, 192, 0.6)";
  myChart.update();
});
